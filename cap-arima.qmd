...
**Invertibilidade:** As condições de invertibilidade do modelo são iguais às condições para que um modelo AR(p) seja estacionário, ou seja, $\abs{\theta} < 1$, ou que as raízes de $\theta(L) = 0$ sejam maiores que 1 em módulo.
